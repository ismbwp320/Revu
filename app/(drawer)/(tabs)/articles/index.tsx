    ...
    <View className="flex-1 bg-gray-50">
      ...
      <ScrollView className="flex-1 px-4 py-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="mb-6">
          ...
          date="5 days ago"
          title="Building Strong Teacher-Student Relationships"
          description="The bond between teachers and students forms the foundation of effective learning. A supportive relationship boosts confidence, motivation, and academic success. Trust,..."
          author="admin"
          likes={0}
          views={5}
        />
