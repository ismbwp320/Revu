        ...
        <View className="mb-6">
          ...
          {/* {JSON.stringify(review)} */}
          {
            sortedEmployees.map((review: any) => (
              ...
              <DiscussionCard
          tags={["Schools", "Schools", "Teahcers", "Students"]}
          category="Education"
          title="The Vital Role of Schools in Shaping Students' Lives"
          description="How do schools influence students’ personal growth and future success?"
          views={2}
          likes={0}
          comments={1}
          date="6 days ago"
